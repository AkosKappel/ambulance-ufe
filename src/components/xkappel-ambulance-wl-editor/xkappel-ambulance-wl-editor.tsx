...
@Component({
  tag: 'xkappel-ambulance-wl-editor',
  styleUrl: 'xkappel-ambulance-wl-editor.css',
  shadow: true,
})
export class XkappelAmbulanceWlEditor {
  @Prop() entryId: string;
    ...
    return (
      <Host>
        ...
        <div class="duration-slider">
          ...
          <span class="label">{this.duration.toString().padStart(2, '0')}</span>
